<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nieuwe Training</h2>
    </x-slot>
    <div class="py-12">
                ...
                <div class="p-6">
                    <form action="{{ route('trainings.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700"></textarea>
                        </div>
